...
class TracerBN(minimalmodbus.Instrument):
    ...
    def __init__(self, portname=DEFAULT_SERIAL_PORT_NAME, slaveaddress=DEFAULT_MODBUS_ADDRESS):
        ...
        self.debug = True      # Set minimal modbus debugging on or off
    ...
    def get_batt_status(self):
        ...
        # statuses contains four parameters to read (unpack) from various bits across the 2 bytes recieved.

        # Battery Status, comprises bits 0-3, they hold values 0-4 only. They indicate;
        #   (0) Normal | (1) Overvolt | (2) Undervolt | (3) Low volt dissconnect | (4) Fault
    ...
    def get_charging_equip_status(self):
        ...
        # statuses contains 12 parameters to read (unpack) from various bits across the 2 bytes recieved.
    ...
    def get_load_power(self):
        ...
        return switch_4_bytes(self.read_long(int(0x310E), 4, signed=True)) / 100.0
